...
const profileData = {
  backgroundImage: '/cow.jpg', // must be inside /public  375 This effect 
...
export const MouseFollowCaption = () => {
  ...
  return (
    <>
      <figure
        ref={ref}
        className="relative flex h-[375px] w-full flex-col items-center justify-center overflow-hidden"
        style={{
          perspective: "800px",
        }}
